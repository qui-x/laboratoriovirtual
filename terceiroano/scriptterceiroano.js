(function(){
  ...
  /* ============================================================
     MENU DO 3º ANO — indexterceiroano.html
     ------------------------------------------------------------
     Mesmo contrato dos menus do 1º e do 2º ano
     (scriptprimeiroano.js / scriptsegundoano.js): esta página não
     tem painel de acessibilidade próprio. Ela só lê o estado que
     chega pela URL (definido no painel de seleção de ano,
