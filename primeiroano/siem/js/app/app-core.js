...
class App {
  constructor() {
    ...
    this._resize(); this._activeSubCat='all'; this._buildSubCatTabs(); this._buildList(); this._bindEvents(); this._initPanels(); this._initExpand(); this._initMobileMenu(); this._loop();
