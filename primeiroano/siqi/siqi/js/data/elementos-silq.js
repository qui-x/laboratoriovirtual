/* ═══════════════════════════════════════════════════════════════
   ...
   ARQUIVO: elementos-silq.js
   ───────────────────────────────────────────────────────────────
   Cópia verbatim de js/data/tabela-elementos.js do SILQ (Simulador
   Interativo de Ligações Químicas) — os mesmos 118 elementos que
   alimentam a tabela periódica, o cálculo de comprimento de ligação
   e o motor VSEPR de lá. Reaproveitado aqui como fonte de cor/raio/
   valência/eletronegatividade pro renderizador 3D da "Estrutura
   Molecular" da Ficha do SIQI — mesma integração entre simuladores
   da plataforma, sem duplicar os dados à mão.
