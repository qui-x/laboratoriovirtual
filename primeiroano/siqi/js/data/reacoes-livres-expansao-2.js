...
(function(){
  ...
  'HF': [
    { id:'hf_naoh', icon:'flask', familia:'Neutralização',
    ...
    { id:'hf_sio2', icon:'flame', familia:'Dissolução de Vidro',
    ...
    { id:'hf_caoh2', icon:'flask', familia:'Neutralização',
  ...
  'HBr': [
    { id:'hbr_naoh', icon:'flask', familia:'Neutralização',
    ...
    { id:'hbr_agno3', icon:'precipitate', familia:'Precipitação',
    ...
    { id:'hbr_mg', icon:'bolt', familia:'Simples Troca',
  ...
  'HI': [
    { id:'hi_naoh', icon:'flask', familia:'Neutralização',
    ...
    { id:'hi_cl2', icon:'bolt', familia:'Oxirredução',
    ...
    { id:'hi_h2so4', icon:'bolt', familia:'Oxirredução',
  ...
  'H2S': [
    { id:'h2s_naoh', icon:'flask', familia:'Neutralização',
    ...
    { id:'h2s_pbno3', icon:'precipitate', familia:'Precipitação (Teste)',
    ...
    { id:'h2s_o2', icon:'flame', familia:'Combustão',
  ...
  'HClO': [
    { id:'hclo_naoh', icon:'flask', familia:'Neutralização',
    ...
    { id:'hclo_cl2', icon:'precipitate', familia:'Equilíbrio',
    ...
    { id:'hclo_luz', icon:'sun', familia:'Fotodecomposição',
  ...
  'Ba(OH)2': [
    { id:'baoh2_h2so4', icon:'precipitate', familia:'Neutralização/Precipitação',
    ...
    { id:'baoh2_hcl', icon:'flask', familia:'Neutralização',
    ...
    { id:'baoh2_nh4cl', icon:'snow', familia:'Reação Endotérmica',
  ...
  'Al(OH)3': [
    { id:'aloh3_hcl', icon:'flask', familia:'Reação com Ácido',
    ...
    { id:'aloh3_naoh', icon:'bolt', familia:'Reação com Base (Anfótero)',
    ...
    { id:'aloh3_calor', icon:'thermometer', familia:'Decomposição',
  ...
  'Fe(OH)3': [
    { id:'feoh3_hcl', icon:'flask', familia:'Reação com Ácido',
    ...
    { id:'feoh3_calor', icon:'thermometer', familia:'Decomposição',
    ...
    { id:'feoh3_form', icon:'precipitate', familia:'Precipitação',
  ...
  'NaHCO3': [
    { id:'nahco3_hcl', icon:'refresh', familia:'Dupla Troca',
    ...
    { id:'nahco3_calor', icon:'thermometer', familia:'Decomposição',
    ...
    { id:'nahco3_naoh', icon:'flask', familia:'Neutralização Parcial',
  ...
  'KNO3': [
    { id:'kno3_form', icon:'flask', familia:'Neutralização',
    ...
    { id:'kno3_calor', icon:'flame', familia:'Decomposição',
    ...
    { id:'kno3_comb', icon:'flame', familia:'Decomposição (Alta T)',
  ...
  'CaCO3': [
    { id:'caco3_hcl', icon:'refresh', familia:'Dupla Troca',
    ...
    { id:'caco3_calor', icon:'factory', familia:'Decomposição (Calcinação)',
    ...
    { id:'caco3_h2o_co2', icon:'droplet', familia:'Dissolução Cárstica',
  ...
  'BaSO4': [
    { id:'baso4_form', icon:'precipitate', familia:'Precipitação',
    ...
    { id:'baso4_form2', icon:'precipitate', familia:'Precipitação',
    ...
    { id:'baso4_calor', icon:'flame', familia:'Decomposição (Alta T)',
  ...
  'ZnSO4': [
    { id:'znso4_form', icon:'bolt', familia:'Simples Troca',
    ...
    { id:'znso4_naoh', icon:'precipitate', familia:'Precipitação',
    ...
    { id:'znso4_barium', icon:'precipitate', familia:'Precipitação (Teste SO₄²⁻)',
  ...
  'FeSO4': [
    { id:'feso4_form', icon:'bolt', familia:'Simples Troca',
    ...
    { id:'feso4_naoh', icon:'precipitate', familia:'Precipitação',
    ...
    { id:'feso4_kmno4', icon:'bolt', familia:'Oxirredução',
  ...
  'KMnO4': [
    { id:'kmno4_h2o2', icon:'bolt', familia:'Oxirredução',
    ...
    { id:'kmno4_feso4', icon:'bolt', familia:'Permanganatometria',
    ...
    { id:'kmno4_hcl', icon:'bolt', familia:'Oxirredução',
  ...
  'AlCl3': [
    { id:'alcl3_naoh', icon:'precipitate', familia:'Precipitação',
    ...
    { id:'alcl3_naoh_exc', icon:'bolt', familia:'Deslocamento (Anfótero)',
    ...
    { id:'alcl3_h2o', icon:'droplet', familia:'Hidrólise',
  ...
  'N2O5': [
    { id:'n2o5_h2o', icon:'droplet', familia:'Síntese',
    ...
    { id:'n2o5_naoh', icon:'flask', familia:'Neutralização',
    ...
    { id:'n2o5_decomp', icon:'thermometer', familia:'Decomposição',
      titulo:'2 N₂O₅ → 4 NO₂ + O₂',
  ...
  'P2O5': [
    { id:'p2o5_h2o', icon:'droplet', familia:'Síntese',
    ...
    { id:'p2o5_naoh', icon:'flask', familia:'Neutralização',
    ...
    { id:'p2o5_cao', icon:'flame', familia:'Síntese',
