/* ═══════════════════════════════════════════════════════════════
   CAMADA: DADOS
   ARQUIVO: geometrias-moleculares.js
   ───────────────────────────────────────────────────────────────
   Banco de geometrias moleculares específicas da literatura (ângulos
   reais NIST/IUPAC, hibridização, nota estereoquímica) por fórmula —
   usado pelo botão "Snap Literatura" e pelo visualizador 3D para
   posicionar átomos exatamente como a química real, em vez de usar
   só a aproximação genérica da teoria VSEPR.
   Depende de: nada.
   Usado por: js/init/controles-fisica.js (snap literatura),
              js/molecules/estereoquimica.js, js/view3d/view3d.js.
═══════════════════════════════════════════════════════════════ */
