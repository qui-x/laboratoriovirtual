...
class Quiz {
  ...
  responder(j, btn) {
    ...
    exp.hidden = false;
    exp.innerHTML = `<strong>${certo ? '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M20 6 9 17l-5-5" /></svg> Correto!' : '<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M18 6 6 18" /><path d="m6 6 12 12" /></svg> Não foi dessa vez.'}</strong> ${q.exp}`;
  ...
  render() {
    ...
    if (this.i >= N) {
      ...
      this.area.innerHTML = `
        <article class="quiz-card quiz-final" aria-label="Resultado do bloco de questões">
          ...
          <div class="quiz-foot">
            <button class="action-btn quiz-next" data-action="refazer"><span aria-hidden="true"><svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 12a9 9 0 0 0-9-9 9.75 9.75 0 0 0-6.74 2.74L3 8" /><path d="M3 3v5h5" /><path d="M3 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L21 16" /><path d="M16 16h5v5" /></svg></span> Refazer com nova ordem</button>
          </div>
        </article>`;
    ...
    this.area.innerHTML = `
      <article class="quiz-card" aria-label="Questão ${this.i + 1} de ${N}">
        ...
        <div class="quiz-foot">
          <button class="action-btn quiz-next" data-action="proxima" disabled>Próxima questão <span aria-hidden="true"><svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg></span></button>
        </div>
      </article>`;
