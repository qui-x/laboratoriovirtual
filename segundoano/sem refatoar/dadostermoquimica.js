...
window.SITQ_DATA = {
  ...
  /* ══════════════════════════════════════════════════════════════
     MODO 6 — ESPONTANEIDADE: ΔG = ΔH − T·ΔS
     Fechava a maior lacuna do SITQ: entropia e energia livre nao existiam
     em nenhum lugar do simulador (grep por "gibbs" e "entropia" dava zero).
     E e justamente ΔG que responde "por que o gelo derrete sozinho, se o
     processo ABSORVE calor?".

     ΔH em kJ/mol e ΔS em J/(mol·K) — atencao a unidade, e o erro classico:
     no calculo de T·ΔS o ΔS precisa ser dividido por 1000.
     Temperatura de inversao: ΔG = 0  ⇒  T = ΔH/ΔS  (em kelvin).

     FONTES: ΔH°f e S° a 298 K do CRC Handbook (97a ed.) e do NIST-JANAF;
     os valores abaixo sao os ΔH° e ΔS° de reacao calculados a partir delas.
     ══════════════════════════════════════════════════════════════ */
  REACOES_GIBBS: [
    { id: 'fusaogelo', nome: 'Fusão do gelo', eq: 'H₂O(s) → H₂O(l)',
      dH: 6.01, dS: 22.0, cor: '#38bdf8',
      desc: 'O caso que dá sentido a tudo: ABSORVE calor (ΔH > 0) e ainda assim acontece sozinho acima de 0 °C. Quem paga a conta é a entropia: o líquido é muito mais desorganizado que o cristal. A temperatura de inversão calculada cai em 273,2 K — exatamente o ponto de fusão, que deixa de ser um número decorado e passa a ser consequência.' },
    { id: 'vaporizacao', nome: 'Vaporização da água', eq: 'H₂O(l) → H₂O(g)',
      dH: 40.65, dS: 108.9, cor: '#22d3ee',
      desc: 'Mesma lógica, salto de entropia muito maior (gás), e a inversão dá 373,3 K — o ponto de ebulição a 1 atm.' },
    { id: 'metanocomb', nome: 'Combustão do metano', eq: 'CH₄(g) + 2 O₂(g) → CO₂(g) + 2 H₂O(l)',
      dH: -890.4, dS: -242.8, cor: '#f87171',
      desc: 'ΔH < 0 e ΔS < 0: espontânea em toda temperatura razoável, porque o termo entálpico domina com folga. Só deixaria de ser espontânea acima de ~3.667 K, temperatura em que nada disso existiria como líquido.' },
    { id: 'caco3dec', nome: 'Decomposição do calcário', eq: 'CaCO₃(s) → CaO(s) + CO₂(g)',
      dH: 178.3, dS: 160.6, cor: '#fbbf24',
      desc: 'O exemplo industrial perfeito de inversão: ΔH > 0 e ΔS > 0, então só é espontânea em ALTA temperatura. A inversão dá 1.110 K (837 °C) — e os fornos de cal operam justamente acima disso, não por acaso.' },
    { id: 'amoniasint', nome: 'Síntese da amônia (Haber)', eq: 'N₂(g) + 3 H₂(g) → 2 NH₃(g)',
      dH: -92.2, dS: -198.7, cor: '#a78bfa',
      desc: 'ΔH < 0 e ΔS < 0: espontânea apenas em BAIXA temperatura (abaixo de 464 K). O dilema industrial em uma frase: a termodinâmica quer frio, a cinética quer calor — e a indústria resolve com catalisador e alta pressão.' },
    { id: 'nh4no3dis', nome: 'Dissolução do nitrato de amônio', eq: 'NH₄NO₃(s) → NH₄⁺(aq) + NO₃⁻(aq)',
      dH: 25.7, dS: 108.7, cor: '#4ade80',
      desc: 'A compressa fria instantânea: endotérmica e espontânea à temperatura ambiente. O ganho de entropia da rede cristalina que se desfaz em íons hidratados vence os 25,7 kJ absorvidos.' },
    { id: 'fotossint', nome: 'Fotossíntese', eq: '6 CO₂(g) + 6 H₂O(l) → C₆H₁₂O₆(s) + 6 O₂(g)',
      dH: 2803, dS: -262.0, cor: '#84cc16',
      desc: 'ΔH > 0 e ΔS < 0: NUNCA espontânea, a nenhuma temperatura. Não há temperatura de inversão. Só ocorre porque a luz do Sol fornece energia de fora — é o contraexemplo que mostra que "não espontâneo" não significa "impossível".' },
    { id: 'ferrugem', nome: 'Oxidação do ferro (ferrugem)', eq: '4 Fe(s) + 3 O₂(g) → 2 Fe₂O₃(s)',
      dH: -1648, dS: -549.4, cor: '#b45309',
      desc: 'Fortemente espontânea (ΔG ≈ −1.485 kJ a 25 °C) e ainda assim lenta o bastante para levar anos: espontaneidade diz SE pode acontecer, nunca com que rapidez. É a confusão mais comum entre termodinâmica e cinética.' },
  ],
  ...
  MODO_INFO: {
    ...
    gibbs:'ΔH sozinho não decide se um processo acontece: o gelo derrete espontaneamente ABSORVENDO calor. Quem decide é a energia livre de Gibbs, ΔG = ΔH − T·ΔS, que junta a tendência de liberar energia (ΔH) com a de aumentar a desordem (ΔS). ΔG < 0: espontâneo. ΔG > 0: não espontâneo (o inverso é que é). ΔG = 0: equilíbrio. Como ΔG é uma RETA em função de T, com coeficiente angular −ΔS, os quatro pares de sinais dão quatro comportamentos: sempre espontâneo, nunca espontâneo, e os dois casos que dependem da temperatura — e nesses existe uma temperatura de inversão, T = ΔH/ΔS.',
  },
  FORMULAS: {
    ...
    gibbs:   { f:'ΔG = ΔH − T·ΔS   ·   T_inversão = ΔH/ΔS', nota:'ΔH em kJ/mol, ΔS em J/(mol·K) — divida ΔS por 1000 antes de multiplicar por T, é o erro mais comum. T em KELVIN, sempre. ΔG < 0 espontâneo · ΔG = 0 equilíbrio · ΔG > 0 não espontâneo. A temperatura de inversão só existe quando ΔH e ΔS têm o MESMO sinal. Dados de ΔH°f e S° a 298 K: CRC Handbook e NIST-JANAF.' },
  },
  ...
  CURIOSIDADES: [
    ...
    'O ponto de fusão do gelo (273,2 K) não é um número arbitrário: é exatamente ΔH/ΔS da fusão, a temperatura em que ΔG passa de positivo para negativo.',
    'A ferrugem tem ΔG de −1.485 kJ: violentamente espontânea, e ainda assim leva anos. Espontâneo não quer dizer rápido.',
    'Fornos de cal operam acima de 837 °C porque é aí que ΔG da decomposição do CaCO₃ fica negativo — a temperatura foi escolhida pela termodinâmica.',
    'A síntese da amônia é o dilema industrial clássico: ΔG pede frio, a velocidade pede calor. Haber e Bosch resolveram com catalisador e 200 atm.',
    'A fotossíntese tem ΔG positivo a qualquer temperatura: ela só ocorre porque a luz do Sol entra na conta como energia externa.',
  ],
};
